...
function LandingPage({ onSelectBuilding }) {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center bg-[#f3f6fb]">
      <Container>
        <h2 className="text-3xl font-bold text-primary text-center mb-2">Select a Building</h2>
        <p className="text-center text-gray-600 mb-4">Choose from our available college buildings</p>
